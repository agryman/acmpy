# This module implements the lookup of precomputed SO(5) > SO(3) Clebsch-Gordan coefficients.
...
# define a class to represent the database of precompute SO5 > SO3 Clebsch Gordan coefficients
# class SO5_SO3_CG:
...
def is_level_3(path):
    """Returns True is and only if path is file whose name is like 'SO5CG_1_2-1-4_3'."""
